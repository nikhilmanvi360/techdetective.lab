...
export default function AdminOverview() {
 ...
 <div>
 <div className="text-[10px] font-display text-[#A52A2A]/60 uppercase tracking-[0.5em] mb-2">// GLOBAL STATUS</div>
 ...
 {/* Recent Event Log */}
 <div>
 <div className="flex items-center gap-3 mb-4 border-b border-[rgba(139,105,20,0.4)] pb-3">
 <Activity className="w-4 h-4 text-[#A52A2A]" />
 <h2 className="text-sm font-display text-white uppercase tracking-widest">Live Event Stream</h2>
 <div className="w-1.5 h-1.5 rounded-full bg-[#8B1A1A] animate-pulse ml-auto" />
 </div>
 ...
 className="flex items-center gap-4 bg-black/40 border border-[rgba(139,105,20,0.4)] p-3 font-mono text-xs"
 >
 <Zap className="w-3 h-3 text-[#c8a050] flex-shrink-0" />
