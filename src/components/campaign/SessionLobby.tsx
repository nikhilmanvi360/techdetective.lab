  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0a0702]/90 backdrop-blur-sm">
      <motion.div
        ...
        className="w-[600px] shadow-2xl relative overflow-hidden flex flex-col rounded-[1.75rem]"
        style={{
      ...
      >
        <div className="text-center py-8 border-b-4 border-[#a07830] relative bg-[#2a1a0a]">
          <ShieldAlert className="w-12 h-12 text-[#f0e0a0] mx-auto mb-2" />
          <h2 className="text-3xl font-black text-[#f0e0a0] uppercase tracking-widest">Investigation Session</h2>
          <p className="text-[#d7bb86] font-serif mt-2 tracking-wide text-sm">Shared campaign desk for two investigators</p>
        </div>
          ...
          {mode === 'select' && (
            <div className="flex gap-6">
              <button 
                ...
                className="flex-1 bg-[#2a1a0a] text-[#f0e0a0] border-2 border-[#a07830] p-6 hover:bg-[#a07830] hover:text-[#2a1a0a] transition-all flex flex-col items-center gap-3 rounded-2xl shadow-[0_14px_24px_rgba(42,26,10,0.18)]"
              >
              ...
              <button 
                ...
                className="w-full bg-[#2a1a0a] text-[#f0e0a0] border-2 border-[#a07830] p-4 hover:bg-[#a07830] hover:text-[#2a1a0a] transition-all flex items-center justify-center gap-2 disabled:opacity-50 rounded-2xl"
              >
            ...
            <div className="flex flex-col items-center space-y-8">
              ...
              {isHost ? (
                <button
                  ...
                  className="w-full py-4 border-4 border-[#2a1a0a] text-lg font-black uppercase tracking-widest transition-all disabled:opacity-50 disabled:cursor-not-allowed bg-[#2a1a0a] text-[#f0e0a0] hover:bg-[#a07830] hover:text-[#2a1a0a] rounded-2xl"
                >
